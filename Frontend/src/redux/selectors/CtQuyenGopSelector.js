...
/** Selector **/
const ctQuyenGopSelector = (state) => state.CtQuyenGop;

const selectListCtQuyenGopSelector = createSelector(
    ctQuyenGopSelector,
...
/** function */
export const selectListCtQuyenGop = (state) => {
    return selectListCtQuyenGopSelector(state);
}
